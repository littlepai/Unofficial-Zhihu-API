...
class Zhihu():
    ...
    def __init__(self, username=None, password=None):
        ...
        # 恢复权重
        self.__sess = self.__restoreSess('./checkpoint/')
    ...
    # 恢复权重
    def __restoreSess(self, checkpoint='./checkpoint/'):
    ...
    def login(self, username=None, password=None):
        ...
        self.__username = username if username else input("请输入用户名：")
        self.__password = password if password else input("请输入密码：")
